...
resg_merge_net_profit <- resg_merge_anom_avg %>% 
  mutate(almond_production_costs = almond_production_costs) %>% # USe production costs of $3800 per acre
...
NPV = compute_NPV(resg_merge_net_profit$net_profit,22) # 22 is number of years
