...
# NPV
resg_merge_net_profit <- resg_merge %>% 
  mutate(almond_production_costs = resg_merge$yield_anomaly_tons_per_acre * almond_production_costs) %>% # calculate production costs by multiplying yield anomaly to almond production costs
  mutate(almond_profit = resg_merge$yield_anomaly_tons_per_acre * almond_profit) %>% # calculate almond profit by multiplying yield anomaly to almond profit 
...
NPV = compute_NPV(resg_merge_net_profit$net_profit,resg_merge_net_profit$year)
